...
public class FilmeController {
	...
	public String persistirFilme(@RequestParam String nome, @RequestParam String genero, @RequestParam Integer ano, @RequestParam String nomeAutor, @RequestParam String dataNascimentoAutor) {
